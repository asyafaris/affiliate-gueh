...
export const metadata = buildMetadata({
  title: "Tentang worthgoods",
  description: "Misi, prinsip editorial, dan cara worthgoods memilih rekomendasi produk.",
  path: "/tentang"
});
  ...
  return (
    <>
      ...
      <main className="container-page max-w-4xl py-12">
        ...
        <h1 className="mt-3 text-5xl font-bold">Kami membantu Anda membeli lebih sadar, bukan lebih impulsif.</h1>
        <div className="mt-8 grid gap-6 text-lg leading-8 text-neutral-600">
          <p>worthgoods adalah hub editorial-commerce Indonesia untuk setup kerja, produktivitas, gadget ringan, home office, dan barang kamar yang tetap fungsional.</p>
